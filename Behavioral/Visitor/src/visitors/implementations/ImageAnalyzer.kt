...
class ImageAnalyzer : ArtificialIntelligenceVisitor {
    override fun visitChatGPT(chatGPT: ChatGPT) {
        println("${chatGPT.name} was powered by image analyzer")
    }

    override fun visitDeepSeek(deepSeek: DeepSeek) {
        println("${deepSeek.name} was powered by image analyzer")
    }

    override fun visitClaude(claude: Claude) {
        println("${claude.name} was powered by image analyzer")
    }
